      ...
      <CardContent className="p-4">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Saldo: {formatCurrency(fromAccount.balance)}</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Saldo: {formatCurrency(toAccount.balance)}</div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-border pt-3">
            <div className="text-xs text-muted-foreground mb-2">Saldo setelah transfer:</div>
            <div className="flex justify-between text-sm">
              <div className="flex items-center gap-2">
